function CharacterIntro() {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("img", { src: "images/Kitasan.jpg", alt: "Silver Wolf", className: "character-image-default" }),
      React.createElement("img", { src: "images/KitasanBlack.jpg", alt: "Silver Wolf Transformed", className: "character-image-transformed" })
    )
  );
}
